...
variable "aws_subnet_ids" {
  ...
  # default     = ["subnet-a1e765ec"]
  # default     = ["subnet-e12cdf87", "subnet-a1e765ec"]
  # default     = ["subnet-a1e765ec", "subnet-e6a45bb9"]
  # default     = ["subnet-01234567890abcdef"]
  # default     = ["subnet-01234567890abcdef", "subnet-01234567890abcdef"]
